...
// Channels Mira does not deliver on yet. Connect explains itself instead
// of doing anything.
    ...
    <form onSubmit={submit} className="mt-6 space-y-8">
        ...
        <label className="flex items-start gap-3">
          ...
          <span>
            ...
            <span className="mt-0.5 block text-sm text-muted">
              When a flight is delayed or cancelled, Mira books the
      ...
      <Card className="p-5">
        ...
        <p className="mt-0.5 text-sm text-muted">
          The most Mira may spend for you without asking first. Anything
      ...
      <Card className="p-5">
        ...
        <p className="mt-0.5 text-sm text-muted">Where Mira may reach you.</p>
    ...
    <li className="flex items-center justify-between gap-3 py-3">
      <div>
        ...
        <div className="text-sm text-muted">
          {asked ? `Not available yet. Mira will tell you when ${label} is ready.` : note}
        </div>
      </div>
